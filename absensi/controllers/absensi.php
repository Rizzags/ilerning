...
if ($this->form_validation->run() == FALSE){
		...
		function cetak_rps_realisasi(){
			$id_jadual 		= $this->uri->segment(3);
			$data['record'] = $this->absensi_model->cetak_rps_realisasi1($id_jadual)->row_array();
			$data['record2'] = $this->absensi_model->cetak_rps_realisasi2($id_jadual);
			$this->load->view('cetak_rps_realisasi',$data);
		}
