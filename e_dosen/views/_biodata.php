...
:?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo anchor( 'absensi/rps/'.$row->id_mtk,'Lihat RPS |'); ?> 
									<?php echo anchor( 'absensi/rekap_mhs_dosen/'.$row->id_jadual,'Lihat Absen |'); ?> 
									<?php echo anchor('absensi/absen_detail_mutu/'.$row->id_jadual,'Pelaksanaan |'); ?> 
